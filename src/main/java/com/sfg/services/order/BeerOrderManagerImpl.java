package com.sfg.services.order;
...
import com.sfg.statemachine.BeerOrderStateChangeInterceptor;
...
public class BeerOrderManagerImpl implements BeerOrderManager {
    ...
    public void processValidationResult(UUID beerOrderId, Boolean isValid) {
        ...
        log.info("beerOrderOption present? :  {} ", beerOrderOptional.isPresent());
    ...
    public void beerOrderAllocationPassed(BeerOrderDto beerOrderDto) {
        ...
        log.info("beerOrderOptional is here {}" , beerOrderOptional);
    ...
    public void beerOrderAllocationFailed(BeerOrderDto beerOrderDto) {
        ...
        beerOrderOptional.ifPresentOrElse(beerOrder -> sendBeerOrderEvent(beerOrder, BeerOrderEventEnum.ALLOCATION_FAILED), () -> log.error("Order Not Found. Id: " + beerOrderDto.getId()) );
    ...
    private void awaitForStatus(UUID beerOrderId, BeerOrderStatusEnum statusEnum) {
        ...
        while (!found.get()) {
            if (loopCount.incrementAndGet() > 10) {
                found.set(true);
                log.info("Loop Retries exceeded");
            }
            ...
            beerOrderRepository.findById(beerOrderId).ifPresentOrElse(beerOrder -> {
                if (beerOrder.getOrderStatus().equals(statusEnum)) {
                    ...
                    log.info("Order Status Not Equal. Expected: " + statusEnum.name() + " Found: " + beerOrder.getOrderStatus().name());
                }
